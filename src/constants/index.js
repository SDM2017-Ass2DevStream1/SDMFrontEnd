...
export const SEARCH_CONDITION_FIELD_TYPE = {
  AUTHORS: 1,
  RATING: 2,
  DESIGN: 3,
  METHOD: 4,
...
export const SEARCH_FIELD_OPERATORS = {
  [SEARCH_CONDITION_FIELD_TYPE.AUTHORS]: {
    operators: convertToOptions([
      ...
      SEARCH_CONDITION_OPRATOR.ENDS_WITH,
  ...
  [SEARCH_CONDITION_FIELD_TYPE.RATING]: {
    ...
    options: convertToOptions([1, 2, 3, 4, 5]),
  },

  [SEARCH_CONDITION_FIELD_TYPE.DESIGN]: {
    operators: convertToOptions([
      SEARCH_CONDITION_OPRATOR.CONTAINS,
      SEARCH_CONDITION_OPRATOR.DOES_NOT_CONTAINS,
      SEARCH_CONDITION_OPRATOR.IS_EQUAL_TO,
  ...
  [SEARCH_CONDITION_FIELD_TYPE.METHOD]: {
    operators: convertToOptions([
      SEARCH_CONDITION_OPRATOR.CONTAINS,
      SEARCH_CONDITION_OPRATOR.DOES_NOT_CONTAINS,
      SEARCH_CONDITION_OPRATOR.IS_EQUAL_TO,
  ...
  [SEARCH_CONDITION_FIELD_TYPE.METHODOLOGY]: {
    operators: convertToOptions([
      SEARCH_CONDITION_OPRATOR.CONTAINS,
      SEARCH_CONDITION_OPRATOR.DOES_NOT_CONTAINS,
      SEARCH_CONDITION_OPRATOR.IS_EQUAL_TO,
